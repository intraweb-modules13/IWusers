...
function IWusers_tables() {
    ...
    $tables['IWusers_column'] = array('suid' => 'iw_suid',
        'uid' => 'iw_uid',
        'id' => 'iw_id',
        'nom' => 'iw_nom',
        'cognom1' => 'iw_cognom1',
    ...
    // IWusers table definition
    $tables['IWusers_import'] = DBUtil::getLimitedTablename('IWusers_import');
    $tables['IWusers_import_column'] = array('suid' => 'iw_suid',
        'uid' => 'iw_uid',
        'id' => 'iw_id',
        'nom' => 'iw_nom',
        'cognom1' => 'iw_cognom1',
    ...
    $tables['IWusers_import_column_def'] = array('suid' => "I NOTNULL AUTO PRIMARY",
        'uid' => "I NOTNULL DEFAULT '0'",
        'id' => "C(50) NOTNULL DEFAULT ''",
        'nom' => "C(25) NOTNULL DEFAULT ''",
        'cognom1' => "C(25) NOTNULL DEFAULT ''",
        ...
        'naixement' => "C(8) NOTNULL DEFAULT ''",
        'accio' => "I(1) NOTNULL DEFAULT '0'",
        'contrasenya' => "C(25) NOTNULL DEFAULT ''",
        'login' => "C(25) NOTNULL DEFAULT ''",
        'email' => "C(60) NOTNULL DEFAULT ''",
        'grup' => "C(20) NOTNULL DEFAULT ''");

    // IWusers table definition
    $tables['IWusers_aux'] = DBUtil::getLimitedTablename('IWusers_aux');
    $tables['IWusers_aux_column'] = array('suid' => 'iw_suid',
        'uid' => 'iw_uid',
        'id' => 'iw_id',
        'nom' => 'iw_nom',
        'cognom1' => 'iw_cognom1',
    ...
    $tables['IWusers_aux_column_def'] = array('suid' => "I NOTNULL AUTO PRIMARY",
        'uid' => "I NOTNULL DEFAULT '0'",
        'id' => "C(50) NOTNULL DEFAULT ''",
        'nom' => "C(25) NOTNULL DEFAULT ''",
        'cognom1' => "C(25) NOTNULL DEFAULT ''",
